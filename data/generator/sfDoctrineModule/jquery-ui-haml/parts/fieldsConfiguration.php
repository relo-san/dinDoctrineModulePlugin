...
<?php unset( $this->config['list']['params'] ) ?>
    ...
    } // Base<?php echo ucfirst( $this->getModuleName() ) ?>GeneratorConfiguration::getListParams()
...
<?php unset( $this->config['list']['layout'] ) ?>
    ...
    } // Base<?php echo ucfirst( $this->getModuleName() ) ?>GeneratorConfiguration::getListLayout()
...
<?php unset( $this->config['list']['title'] ) ?>
    ...
    } // Base<?php echo ucfirst( $this->getModuleName() ) ?>GeneratorConfiguration::getListTitle()
...
<?php unset( $this->config['edit']['title'] ) ?>
    ...
    } // Base<?php echo ucfirst( $this->getModuleName() ) ?>GeneratorConfiguration::getEditTitle()
...
<?php unset( $this->config['new']['title'] ) ?>
    ...
    } // Base<?php echo ucfirst( $this->getModuleName() ) ?>GeneratorConfiguration::getNewTitle()
...
<?php unset( $this->config['filter']['display'] ) ?>
    ...
    } // Base<?php echo ucfirst( $this->getModuleName() ) ?>GeneratorConfiguration::getFilterDisplay()
...
<?php unset( $this->config['form']['display'] ) ?>
    ...
    } // Base<?php echo ucfirst( $this->getModuleName() ) ?>GeneratorConfiguration::getFormDisplay()
...
<?php unset( $this->config['edit']['display'] ) ?>
    ...
    } // Base<?php echo ucfirst( $this->getModuleName() ) ?>GeneratorConfiguration::getEditDisplay()
...
<?php unset( $this->config['new']['display'] ) ?>
    ...
    } // Base<?php echo ucfirst( $this->getModuleName() ) ?>GeneratorConfiguration::getNewDisplay()
...
<?php unset( $this->config['list']['display'], $this->config['list']['hide'] ) ?>
    ...
    } // Base<?php echo ucfirst( $this->getModuleName() ) ?>GeneratorConfiguration::getListDisplay()
...
<?php endforeach ?>
    ...
    } // Base<?php echo ucfirst( $this->getModuleName() ) ?>GeneratorConfiguration::getFieldsDefault()
...
<?php endforeach ?>
    ...
    } // Base<?php echo ucfirst( $this->getModuleName() ) ?>GeneratorConfiguration::getFields<?php echo ucfirst( $context ) ?>()
