...
'&nbsp;/&nbsp;<strong><a onclick="actionAjax(\'actionPartial\',\'[?php echo $listUrl ?]\');return false;" href="[?php echo $listUrl ?]">[?php echo <?php echo $this->getI18NString( 'edit.fields.' . $name . '.label' ) ?> ?]</a></strong>'+
<?php endforeach ?>
<?php endif ?>
[?php $listUrl = Url::url( $helper->getUrlForAction( 'list' ) ) ?]
'&nbsp;/&nbsp;<strong><a onclick="actionAjax(\'actionPartial\',\'[?php echo $listUrl ?]\');return false;" href="[?php echo $listUrl ?]">[?php echo <?php echo $this->getI18NString( 'list.title' ) ?> ?]</a></strong>&nbsp;/&nbsp;[?php echo <?php echo $this->getI18NString( 'edit.title' ) ?> ?]');
}</script>